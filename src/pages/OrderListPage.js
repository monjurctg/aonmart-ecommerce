...
import OrderHorizantalCard from '../components/dashboard/orderList/OrderHorizantalCard';
    ...
    return (
        <DashboardLayout>
            <Tabs defaultActiveKey="complete" id="uncontrolled-tab-example" className="mb-3 orderlist_tab" style={{flexWrap:"nowrap"}}>
                        ...
                        <span className="icon">
                            <svg enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512">
                                <g>
                                    ...
                                    <path d="m152.847 235.159 24.59 121.747c.942 4.665 5.042 8.02 9.802 8.02h47.837c2.899 0 5.656-1.259 7.556-3.45 1.899-2.19 2.755-5.098 2.344-7.968l-17.44-121.747c-.706-4.925-4.925-8.582-9.899-8.582h-54.986c-2.999 0-5.84 1.346-7.739 3.667s-2.659 5.373-2.065 8.313zm56.118 8.02 14.576 101.747h-28.12l-20.551-101.747z"></path>
                                    <path d="m298.667 152.899c42.154 0 76.45-34.295 76.45-76.45s-34.296-76.449-76.45-76.449-76.449 34.295-76.449 76.449 34.295 76.45 76.449 76.45zm0-132.899c31.127 0 56.45 25.323 56.45 56.449s-25.323 56.45-56.45 56.45c-31.126 0-56.449-25.323-56.449-56.45 0-31.126 25.323-56.449 56.449-56.449z"></path>
                                    <path d="m289.074 100.23c1.889 1.964 4.492 3.069 7.208 3.069.109 0 .22-.002.33-.005 2.833-.094 5.493-1.385 7.319-3.554l28.377-33.7c3.558-4.225 3.017-10.533-1.208-14.09-4.224-3.557-10.533-3.017-14.091 1.208l-21.221 25.201-11.448-11.906c-3.827-3.981-10.159-4.104-14.139-.277-3.981 3.828-4.105 10.159-.277 14.14z"></path>
                                </g>
                            </svg>
                        </span>
                ...
                >
                    <OrderHorizantalCard status="Processing" />
                </Tab>
                                ...
                                <g id="XMLID_1031_">
                                    <g id="XMLID_971_">
                                        <g id="XMLID_977_">
                                            ...
                                            <path id="XMLID_1028_" d="M386.169,266.33h12.332c5.522,0,10-4.478,10-10s-4.478-10-10-10h-12.332c-5.522,0-10,4.478-10,10 S380.646,266.33,386.169,266.33z"></path>
                                            <path id="XMLID_1004_" d="M103.835,256.006c0,5.522,4.478,10,10,10h12.332c5.522,0,10-4.478,10-10s-4.478-10-10-10h-12.332 C108.313,246.006,103.835,250.483,103.835,256.006z"></path>
                                            <path id="XMLID_1001_" d="M266.33,126.167v-12.332c0-5.522-4.478-10-10-10s-10,4.478-10,10v12.332c0,5.522,4.478,10,10,10 S266.33,131.689,266.33,126.167z"></path>
                                            <path id="XMLID_1415_" d="M246.006,386.169v12.332c0,5.522,4.478,10,10,10s10-4.478,10-10v-12.332c0-5.522-4.478-10-10-10 S246.006,380.646,246.006,386.169z"></path>
                                            <path id="XMLID_996_" d="M206.044,191.901c-3.906-3.904-10.236-3.904-14.143,0c-3.905,3.905-3.905,10.237,0,14.143l33.891,33.891 c-2.597,4.84-4.074,10.367-4.074,16.233c0,18.996,15.454,34.45,34.45,34.45s34.45-15.454,34.45-34.45 c0-5.866-1.478-11.393-4.074-16.233l68.383-68.383c3.905-3.905,3.905-10.237,0-14.143c-3.906-3.904-10.236-3.904-14.143,0 l-68.383,68.383c-4.84-2.597-10.367-4.074-16.233-4.074s-11.393,1.478-16.233,4.074L206.044,191.901z M270.618,256.168 c0,7.968-6.482,14.45-14.45,14.45s-14.45-6.482-14.45-14.45s6.482-14.45,14.45-14.45S270.618,248.2,270.618,256.168z"></path>
                                            <path id="XMLID_980_" d="M135.248,135.248c1.87-1.86,2.939-4.44,2.939-7.07s-1.069-5.2-2.939-7.07     c-1.86-1.859-4.431-2.93-7.07-2.93c-2.63,0-5.21,1.07-7.07,2.93c-1.859,1.86-2.93,4.44-2.93,7.07c0,2.64,1.07,5.21,2.93,7.07     c1.86,1.859,4.44,2.93,7.07,2.93C130.817,138.178,133.388,137.107,135.248,135.248z"></path>
                                            <path id="XMLID_979_" d="M325.438,29.878c2.641,0,5.221-1.061,7.08-2.93c1.86-1.86,2.931-4.431,2.931-7.07     c0-2.63-1.07-5.21-2.931-7.07c-1.859-1.859-4.439-2.93-7.08-2.93c-2.63,0-5.21,1.07-7.069,2.93c-1.86,1.86-2.931,4.44-2.931,7.07     c0,2.64,1.07,5.21,2.931,7.07C320.228,28.817,322.808,29.878,325.438,29.878z"></path>
                                        </g>
                                    </g>
                                </g>
                            </svg>
                ...
                >
                      <OrderHorizantalCard status="Cancel" />
                </Tab>
